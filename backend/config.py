...
class Settings:
    ...
    oss_connect_timeout_seconds: float = float(os.getenv("OSS_CONNECT_TIMEOUT_SECONDS", "15"))
    oss_get_retries: int = int(os.getenv("OSS_GET_RETRIES", "3"))
    oss_cache_ttl_seconds: float = float(os.getenv("OSS_CACHE_TTL_SECONDS", "300"))
